...
namespace UxTracker.Api.Migrations
{
    ...
    [Migration("20241004014906_v1.11-projects")]
    partial class v1110projects
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("UxTracker.Core.Contexts.Account.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("966e68c5-7293-4204-afe0-ab400bad1d41"),
                            Name = "Admin"
                        },
                        new
                        {
                            Id = new Guid("2b3884d7-96ba-4a1a-8507-968f7019e9aa"),
                            Name = "Researcher"
                        },
                        new
                        {
                            Id = new Guid("dbc865ab-5ef9-4d8f-8eca-8207899d0afe"),
                            Name = "Reviewer"
                        });
                });
            ...
            modelBuilder.Entity("UxTracker.Core.Contexts.Research.Entities.Relatory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("92bec92f-c4a6-4d58-8af1-e54b407793fe"),
                            Title = "Visão geral da evolução das avaliações"
                        },
                        new
                        {
                            Id = new Guid("f1f2f879-fde6-470b-8f1d-1d0be84e7535"),
                            Title = "Avaliações de cada usuário por período"
                        },
                        new
                        {
                            Id = new Guid("4f51dda7-ac6e-4039-8ed4-4261d4521da3"),
                            Title = "Distribuição das avaliações por período"
                        },
                        new
                        {
                            Id = new Guid("1572d2d0-8c17-4b73-8a0a-b1cd9bfc79a9"),
                            Title = "Frequência das avaliações por período de tempo"
                        },
                        new
                        {
                            Id = new Guid("39601c7c-61b9-4582-8050-bffb4d088d8a"),
                            Title = "Número adequado de clusters de usuário"
                        },
                        new
                        {
                            Id = new Guid("1898e416-4739-4fec-90e3-04f8f9be1d97"),
